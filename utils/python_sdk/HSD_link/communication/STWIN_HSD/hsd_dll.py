...
from HSD_utils.exceptions import MemoryFreeError, UnsupportedPlatformError
    ...
    def __init__(self):
        ...
        if platform.system() == 'Linux':
            if platform.machine() == 'armv7l':
                ...
                dll_name = "./HSD_link/communication/libhs_datalog/raspberryPi/libhs_datalog_rpi3b.so"
            else:
                dll_name = "./HSD_link/communication/libhs_datalog/linux/libhs_datalog.so"
            self._hsd_dll = cdll.LoadLibrary(dll_name)
        elif platform.system() == 'Windows':
            dll_subfolder = platform.architecture()[0]
            if( dll_subfolder == "32bit"):
                dll_name = "libhs_datalog"
            elif(platform.architecture()[0] == "64bit"):
                dll_name = "libhs_datalog_64"
