...
#define AMC_SNSITIVITY_F_VALUE "sensitivity"
    // #define AMC_LEARN_EP_ID                    1
    // #define AMC_DETECT_EP_ID                   2
    // #define AMC_DATALOG_EP_ID                  3
    // #define AMC_IDLE_EP_ID                     4
    ...
    {
        /**
         * Specifies the number of signals to use for the learning phases. The execution phase
         * ends after analyzing the specified number of signals.
         */
        uint32_t nSignals;
    ...
    typedef struct AutoModeCfg_t
    {
         ...
         * the model has been initialized or not, for example, with the data loaded from a
         * file.
         */
        uint8_t bIsValid;
