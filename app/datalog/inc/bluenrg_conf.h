...
/*---------- Print the data travelling over the SPI in the .csv format compatible with the ST
 * BlueNRG GUI -----------*/
...
/*---------- Scan Interval: time interval from when the Controller started its last scan until
 * it begins the subsequent scan (for a number N, Time = N x 0.625 msec) -----------*/
#define SCAN_P 16384
/*---------- Scan Window: amount of time for the duration of the LE scan (for a number N, Time
 * = N x 0.625 msec) -----------*/
#define SCAN_L 16384
