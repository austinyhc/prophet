...
#define OTA_MAX_PROG_SIZE (0x100000 - 0x4000 - 16)
    ...
    /* API for preparing the Flash for receiving the Update. It defines also the Size of the
     * Update and the CRC value aspected */
    ...
    extern int8_t UpdateFWBlueMS(
        uint32_t* SizeOfUpdateBlueFW,
        uint8_t* att_data,
        int32_t data_length,
