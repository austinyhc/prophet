...
{
  USBD_WCID_STREAMING_DeviceDescriptor, USBD_WCID_STREAMING_LangIDStrDescriptor, USBD_WCID_STREAMING_ManufacturerStrDescriptor,
  USBD_WCID_STREAMING_ProductStrDescriptor, USBD_WCID_STREAMING_SerialStrDescriptor, USBD_WCID_STREAMING_ConfigStrDescriptor,
