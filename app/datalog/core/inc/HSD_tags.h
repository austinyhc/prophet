...
#define TAG_PINx_GPIO_CLK_ENABLE(__TAG_PIN__)                                                 \
    do                                                                                        \
    {                                                                                         \
        if ((__TAG_PIN__) == TAG_PIN0)                                                        \
        {                                                                                     \
            STMOD_PIN_7_GPIO_CLK_ENABLE();                                                    \
        }                                                                                     \
        else if ((__TAG_PIN__) == TAG_PIN1)                                                   \
        {                                                                                     \
            STMOD_PIN_8_GPIO_CLK_ENABLE();                                                    \
        }                                                                                     \
        else if ((__TAG_PIN__) == TAG_PIN2)                                                   \
        {                                                                                     \
            STMOD_PIN_9_GPIO_CLK_ENABLE();                                                    \
        }                                                                                     \
        else if ((__TAG_PIN__) == TAG_PIN3)                                                   \
        {                                                                                     \
            STMOD_PIN_10_GPIO_CLK_ENABLE();                                                   \
        }                                                                                     \
        else if ((__TAG_PIN__) == TAG_PIN4)                                                   \
        {                                                                                     \
            STMOD_PIN_11_GPIO_CLK_ENABLE();                                                   \
        }                                                                                     \
    } while (0)

#define TAG_PINx_GPIO_CLK_DISABLE(__TAG_PIN__)                                                \
    do                                                                                        \
    {                                                                                         \
        if ((__TAG_PIN__) == TAG_PIN0)                                                        \
        {                                                                                     \
            STMOD_PIN_7_GPIO_CLK_DISABLE();                                                   \
        }                                                                                     \
        else if ((__TAG_PIN__) == TAG_PIN1)                                                   \
        {                                                                                     \
            STMOD_PIN_8_GPIO_CLK_DISABLE();                                                   \
        }                                                                                     \
        else if ((__TAG_PIN__) == TAG_PIN2)                                                   \
        {                                                                                     \
            STMOD_PIN_9_GPIO_CLK_DISABLE();                                                   \
        }                                                                                     \
        else if ((__TAG_PIN__) == TAG_PIN3)                                                   \
        {                                                                                     \
            STMOD_PIN_10_GPIO_CLK_DISABLE();                                                  \
        }                                                                                     \
        else if ((__TAG_PIN__) == TAG_PIN4)                                                   \
        {                                                                                     \
    ...
    int32_t HSD_TAGS_set_tag_label(
        COM_Device_t* device, HSD_Tags_Type_t type, uint8_t class_id, const char* label);
    int32_t HSD_TAGS_set_tag_enabled(
        COM_Device_t* device, uint8_t class_id, HSD_Tags_Enable_t enable);
    char* HSD_TAGS_get_tag_label(COM_Device_t* device, HSD_Tags_Type_t type, uint8_t class_id);

    int32_t HSD_TAGS_add_tag(
        HSD_Tags_Type_t type, uint8_t class_id, HSD_Tags_Enable_t enable, double time_stamp);
    int32_t HSD_TAGS_get_tag(
