...
static int32_t get_JSON_from_Device(
    COM_Device_t* device, char** serialized_string, uint8_t pretty);
static int32_t get_JSON_from_DeviceInfo(
    COM_DeviceDescriptor_t* device_descriptor, char** serialized_string);
static int32_t get_JSON_from_TagList(
    COM_TagList_t* tagList, char** serialized_string, uint8_t pretty);
static int32_t get_JSON_from_Sensor(COM_Sensor_t* sensor, char** serialized_string);
static int32_t get_JSON_from_SensorDescriptor(
    COM_SensorDescriptor_t* sensor_descriptor, char** serialized_string);
static int32_t get_JSON_from_SensorStatus(
    uint8_t sensorId, COM_SensorStatus_t* sensor_status, char** serialized_string);
static int32_t get_JSON_from_SubSensorDescriptor(
    COM_SubSensorDescriptor_t* sub_sensor_descriptor, char** serialized_string);
static int32_t get_JSON_from_SubSensorStatus(
    COM_SubSensorStatus_t* sub_sensor_status, char** serialized_string);
static int32_t get_JSON_from_AcquisitionDescriptor(
    COM_AcquisitionDescriptor_t* acquisition_descriptor,
...
static int32_t parse_SetDeviceAliasCommand_from_JSON(
    char* SerializedJSON, char* alias, uint8_t aliasSize);
static int32_t parse_EnableTagCommand_from_JSON(
    char* SerializedJSON, uint8_t* class_id, HSD_Tags_Enable_t* enable);
static int32_t parse_UpdateTagLabelCommand_from_JSON(
    char* SerializedJSON, uint8_t* class_id, char* label, uint8_t labelSize);
static int32_t parse_EnableTag_from_JSON(char* SerializedJSON, HSD_Tags_Enable_t* enable);
static int32_t parse_UpdateTagLabel_from_JSON(
    char* SerializedJSON, uint8_t* class_id, char* label, uint8_t labelSize);
static int32_t parse_AcqInfoCommand_from_JSON(
    char* SerializedJSON, char* name, uint8_t nameSize, char* notes, uint8_t notesSize);
static int32_t parse_MlcConfigCommand_from_JSON(
    char* SerializedJSON,
    uint32_t* mlcConfigSize,
    char* mlcConfigData,
    uint32_t mlcConfigDataSize);
static int32_t parse_StartTime_from_JSON(
    char* SerializedJSON, COM_AcquisitionDescriptor_t* AcquisitionDescriptor);
static int32_t parse_EndTime_from_JSON(
    char* SerializedJSON, COM_AcquisitionDescriptor_t* AcquisitionDescriptor);

static void create_JSON_DeviceInfo(
    COM_DeviceDescriptor_t* device_descriptor, JSON_Value* tempJSON);
...
static void create_JSON_SensorDescriptor(
    COM_SensorDescriptor_t* sensor_descriptor, JSON_Value* tempJSON);
static void create_JSON_SensorStatus(
    uint8_t sensorId, COM_SensorStatus_t* sensor_status, JSON_Value* tempJSON);
static void create_JSON_SubSensorDescriptor(
    COM_SubSensorDescriptor_t* sub_sensor_descriptor, JSON_Value* tempJSON);
static void create_JSON_SubSensorStatus(
    COM_SubSensorStatus_t* sub_sensor_status, JSON_Value* tempJSON);
static void create_JSON_RefreshSensorStatus(
    JSON_Value* tempJSON, uint8_t sensorId, COM_SensorStatus_t* sensor_status);
static void create_JSON_PerformanceStatus(
    JSON_Value* tempJSON, char* chrgState, uint32_t mV, uint32_t level, uint16_t cpu_usage);
static void create_JSON_LoggingStatus(
    JSON_Value* tempJSON, uint8_t sdDetected, uint8_t isLoggingActive);
static void create_JSON_NetworkStatus(
    JSON_Value* tempJSON, char* ssid, char* password, char* ip);
static void create_JSON_DeviceHWTag(
    uint8_t id, const COM_HwTag_t* hwTag, JSON_Value* tempJSON);
static void create_JSON_DeviceSWTag(uint8_t id, char* label, JSON_Value* tempJSON);
static void create_JSON_AcquisitionDescriptor(
    COM_AcquisitionDescriptor_t* acquisition_descriptor, JSON_Value* tempJSON);
 ...
 * @retval 0: no error
 */
int32_t HSD_JSON_set_allocation_functions(
    void* (*malloc_function)(size_t), void (*free_function)(void*))
{
...
int32_t HSD_JSON_serialize_DeviceInfo(
    COM_DeviceDescriptor_t* DeviceInfo, char** SerializedJSON)
{
    return get_JSON_from_DeviceInfo(DeviceInfo, SerializedJSON);
}

int32_t HSD_JSON_serialize_TagList(
    COM_TagList_t* TagList, char** SerializedJSON, uint8_t pretty)
{
...
int32_t HSD_JSON_serialize_SensorDescriptor(
    COM_SensorDescriptor_t* SensorDescriptor, char** SerializedJSON)
{
    return get_JSON_from_SensorDescriptor(SensorDescriptor, SerializedJSON);
}

int32_t HSD_JSON_serialize_SensorStatus(
    uint8_t sensorId, COM_SensorStatus_t* SensorStatus, char** SerializedJSON)
{
    return get_JSON_from_SensorStatus(sensorId, SensorStatus, SerializedJSON);
}

int32_t HSD_JSON_serialize_SubSensorDescriptor(
    COM_SubSensorDescriptor_t* SubSensorDescriptor, char** SerializedJSON)
{
    return get_JSON_from_SubSensorDescriptor(SubSensorDescriptor, SerializedJSON);
}

int32_t HSD_JSON_serialize_SubSensorStatus(
    COM_SubSensorStatus_t* SubSensorStatus, char** SerializedJSON)
{
    return get_JSON_from_SubSensorStatus(SubSensorStatus, SerializedJSON);
}

int32_t HSD_JSON_serialize_Acquisition(
    COM_AcquisitionDescriptor_t* AcquisitionDescriptor, char** SerializedJSON, uint8_t pretty)
{
    return get_JSON_from_AcquisitionDescriptor(AcquisitionDescriptor, SerializedJSON, pretty);
}

int32_t HSD_JSON_serialize_RefreshSensorStatus(
    uint8_t sensorId, COM_SensorStatus_t* SensorStatus, char** SerializedJSON)
{
    int32_t size = 0;
...
int32_t HSD_JSON_serialize_FWStatus_Performance(
    char** SerializedJSON, char* chrgState, uint32_t mV, uint32_t level, uint16_t cpu_usage)
{
    int32_t size = 0;
...
int32_t HSD_JSON_serialize_FWStatus_Logging(
    char** SerializedJSON, uint8_t sdDetected, uint8_t isLoggingActive)
{
    int32_t size = 0;
...
int32_t HSD_JSON_serialize_FWStatus_Network(
    char** SerializedJSON, char* ssid, char* password, char* ip)
{
    int32_t size = 0;
    ...
    COM_Device_t* device, char** serialized_string, uint8_t pretty)
{
    ...
    json_object_dotset_string(
        JSON_Device, "device.deviceInfo.serialNumber", device->deviceDescriptor.serialNumber);
    json_object_dotset_string(
        JSON_Device, "device.deviceInfo.alias", device->deviceDescriptor.alias);
    json_object_dotset_string(
        JSON_Device, "device.deviceInfo.partNumber", device->deviceDescriptor.partNumber);
    json_object_dotset_string(
        JSON_Device, "device.deviceInfo.URL", device->deviceDescriptor.URL);
    json_object_dotset_string(
        JSON_Device, "device.deviceInfo.fwName", device->deviceDescriptor.fwName);
    json_object_dotset_string(
        JSON_Device, "device.deviceInfo.fwVersion", device->deviceDescriptor.fwVersion);
    json_object_dotset_string(
        JSON_Device, "device.deviceInfo.dataFileExt", device->deviceDescriptor.dataFileExt);
    json_object_dotset_string(
        JSON_Device,
        "device.deviceInfo.dataFileFormat",
        device->deviceDescriptor.dataFileFormat);
    json_object_dotset_number(
        JSON_Device, "device.deviceInfo.nSensor", device->deviceDescriptor.nSensor);
    ...
    json_object_dotset_number(
        JSON_Device, "device.tagConfig.maxTagsPerAcq", HSD_TAGS_MAX_PER_ACQUISITION);
...
static int32_t parse_Device_from_JSON(char* SerializedJSON, COM_Device_t* Device)
{
    ...
    if (json_object_dothas_value(JSON_ParseHandler, "device.sensor"))
    {
        ...
        for (ii = 0; ii < size; ii++)
        {
            ...
            {
                StatusText = json_serialize_to_string(
                    json_object_get_value(JSON_subSensorObj, "sensorStatus"));
    ...
    {
        JSON_tagConfigParser =
            json_object_dotget_object(JSON_ParseHandler, "device.tagConfig");
...
static int32_t parse_Command_from_JSON(char* SerializedJSON, COM_Command_t* outCommand)
{
    ...
    if (json_object_dothas_value(JSON_ParseHandler, "command"))
    {
        ...
        else if (strcmp(json_object_dotget_string(JSON_ParseHandler, "command"), "SAVE") == 0)
        {
            ...
            strcmp(json_object_dotget_string(JSON_ParseHandler, "command"), "SWITCH_BANK")
            == 0)
        {
    ...
    if (json_object_dothas_value(JSON_ParseHandler, "request"))
    {
        if (strcmp(json_object_dotget_string(JSON_ParseHandler, "request"), "device") == 0)
        {
            ...
            strcmp(json_object_dotget_string(JSON_ParseHandler, "request"), "deviceInfo") == 0)
        {
            outCommand->request = COM_REQUEST_DEVICE_INFO;
        }
        else if (
            strcmp(json_object_dotget_string(JSON_ParseHandler, "request"), "descriptor") == 0)
        {
            outCommand->request = COM_REQUEST_DESCRIPTOR;
        }
        else if (
            strcmp(json_object_dotget_string(JSON_ParseHandler, "request"), "status") == 0)
        {
            outCommand->request = COM_REQUEST_STATUS;
        }
        else if (
            strcmp(json_object_dotget_string(JSON_ParseHandler, "request"), "register") == 0)
        {
            outCommand->request = COM_REQUEST_REGISTER;
        }
        else if (
            strcmp(json_object_dotget_string(JSON_ParseHandler, "request"), "network") == 0)
        {
            outCommand->request = COM_REQUEST_STATUS_NETWORK;
        }
        else if (
            strcmp(json_object_dotget_string(JSON_ParseHandler, "request"), "sw_tag") == 0)
        {
            outCommand->request = COM_REQUEST_SW_TAG;
        }
        else if (
            strcmp(json_object_dotget_string(JSON_ParseHandler, "request"), "hw_tag") == 0)
        {
            outCommand->request = COM_REQUEST_HW_TAG;
        }
        else if (
            strcmp(json_object_dotget_string(JSON_ParseHandler, "request"), "sw_tag_label")
            == 0)
        {
            outCommand->request = COM_REQUEST_SW_TAG_LABEL;
        }
        else if (
            strcmp(json_object_dotget_string(JSON_ParseHandler, "request"), "hw_tag_label")
            == 0)
        {
            outCommand->request = COM_REQUEST_HW_TAG_LABEL;
        }
        else if (
            strcmp(json_object_dotget_string(JSON_ParseHandler, "request"), "acq_info") == 0)
        {
            outCommand->request = COM_REQUEST_ACQ_INFO;
        }
        else if (
            strcmp(json_object_dotget_string(JSON_ParseHandler, "request"), "tag_config") == 0)
        {
            outCommand->request = COM_REQUEST_TAG_CONFIG;
        }
        else if (
            strcmp(json_object_dotget_string(JSON_ParseHandler, "request"), "log_status") == 0)
        {
            outCommand->request = COM_REQUEST_STATUS_LOGGING;
        }
        else if (
            strcmp(json_object_dotget_string(JSON_ParseHandler, "request"), "mlc_config") == 0)
        {
    ...
    {
        outCommand->sensorId =
            (int8_t)json_object_dotget_number(JSON_ParseHandler, "sensorId");
    }
    else
    {
    ...
    {
        outCommand->subSensorId =
            (int8_t)json_object_dotget_number(JSON_ParseHandler, "subSensorStatus.id");
    }
    else
    {
...
static int32_t parse_Status_from_JSON(char* SerializedJSON, COM_SensorStatus_t* sensorStatus)
{
    ...
    if (json_object_dothas_value(JSON_ParseHandler, "subSensorStatus"))
    {
        ...
        for (ii = 0; ii < size; ii++)
        {
            ...
            {
                sensorStatus->subSensorStatus[subid].ODR =
                    json_object_dotget_number(JSON_subSensorObj, "ODR");
            }
            if (json_object_dothas_value(JSON_subSensorObj, "usbDataPacketSize"))
            {
                sensorStatus->subSensorStatus[subid].usbDataPacketSize =
                    (uint16_t)json_object_dotget_number(
                        JSON_subSensorObj, "usbDataPacketSize");
            }
            if (json_object_dothas_value(JSON_subSensorObj, "sdWriteBufferSize"))
            {
                sensorStatus->subSensorStatus[subid].sdWriteBufferSize =
                    (uint32_t)json_object_dotget_number(
                        JSON_subSensorObj, "sdWriteBufferSize");
            }
            if (json_object_dothas_value(JSON_subSensorObj, "wifiDataPacketSize"))
            {
                sensorStatus->subSensorStatus[subid].wifiDataPacketSize =
                    (uint32_t)json_object_dotget_number(
                        JSON_subSensorObj, "wifiDataPacketSize");
            }
            if (json_object_dothas_value(JSON_subSensorObj, "comChannelNumber"))
            {
                sensorStatus->subSensorStatus[subid].comChannelNumber =
                    (int16_t)json_object_dotget_number(JSON_subSensorObj, "comChannelNumber");
            }
            if (json_object_dothas_value(JSON_subSensorObj, "samplesPerTs"))
            {
                sensorStatus->subSensorStatus[subid].samplesPerTimestamp =
                    (uint16_t)json_object_dotget_number(JSON_subSensorObj, "samplesPerTs");
            }
            if (json_object_dothas_value(JSON_subSensorObj, "FS"))
            {
                sensorStatus->subSensorStatus[subid].FS =
                    json_object_dotget_number(JSON_subSensorObj, "FS");
            }
            if (json_object_dothas_value(JSON_subSensorObj, "sensitivity"))
            {
                sensorStatus->subSensorStatus[subid].sensitivity =
                    json_object_dotget_number(JSON_subSensorObj, "sensitivity");
            }
        }
    }
    json_value_free(tempJSON);
    ...
    char* SerializedJSON, uint8_t* class_id, HSD_Tags_Enable_t* enable)
{
    ...
    {
        HSD_Tags_Enable_t tag_enable =
            (HSD_Tags_Enable_t)json_object_dotget_boolean(JSON_ParseHandler, "enable");
        if (tag_enable == 1)
        {
...
static int32_t parse_EnableTag_from_JSON(char* SerializedJSON, HSD_Tags_Enable_t* enabled)
{
    ...
    {
        HSD_Tags_Enable_t tag_enabled =
            (HSD_Tags_Enable_t)json_object_dotget_boolean(JSON_ParseHandler, "enabled");
        if (tag_enabled == 1)
        {
    ...
    uint32_t mlcConfigDataSize)
{
    ...
    if (json_object_dothas_value(JSON_ParseHandler, "subSensorStatus"))
    {
        ...
        for (ii = 0; ii < size; ii++)
        {
            ...
            {
                uint32_t temp =
                    (uint32_t)json_object_dotget_number(JSON_subSensorObj, "mlcConfigSize");
                *mlcConfigSize = temp;
            }
            else
            {
            ...
            {
                const char* tempData =
                    json_object_dotget_string(JSON_subSensorObj, "mlcConfigData");
    ...
    COM_DeviceDescriptor_t* device_descriptor, JSON_Value* tempJSON)
{
    ...
    json_object_dotset_string(
        JSON_DeviceHandler, "deviceInfo.serialNumber", device_descriptor->serialNumber);
    json_object_dotset_string(
        JSON_DeviceHandler, "deviceInfo.alias", device_descriptor->alias);
    json_object_dotset_string(
        JSON_DeviceHandler, "deviceInfo.partNumber", device_descriptor->partNumber);
    json_object_dotset_string(JSON_DeviceHandler, "deviceInfo.URL", device_descriptor->URL);
    json_object_dotset_string(
        JSON_DeviceHandler, "deviceInfo.fwName", device_descriptor->fwName);
    json_object_dotset_string(
        JSON_DeviceHandler, "deviceInfo.fwVersion", device_descriptor->fwVersion);
    json_object_dotset_string(
        JSON_DeviceHandler, "deviceInfo.dataFileExt", device_descriptor->dataFileExt);
    json_object_dotset_string(
        JSON_DeviceHandler, "deviceInfo.dataFileFormat", device_descriptor->dataFileFormat);
    json_object_dotset_number(
        JSON_DeviceHandler, "deviceInfo.nSensor", device_descriptor->nSensor);
}
...
static void create_JSON_TagList(COM_TagList_t* tagList, JSON_Value* tempJSON)
{
    ...
    json_object_dotset_number(
        JSON_TagList, "tagConfig.maxTagsPerAcq", HSD_TAGS_MAX_PER_ACQUISITION);
    ...
    COM_SensorDescriptor_t* sensor_descriptor, JSON_Value* tempJSON)
{
    ...
    json_object_dotset_value(
        JSON_SensorDescriptor, "subSensorDescriptor", json_value_init_array());
    ...
    {
        tempJSON1 = json_value_init_object();
        create_JSON_SubSensorDescriptor(
            &sensor_descriptor->subSensorDescriptor[ii], tempJSON1);
    ...
    COM_SubSensorDescriptor_t* sub_sensor_descriptor, JSON_Value* tempJSON)
{
    ...
    json_object_dotset_number(
        JSON_SubSensorDescriptor, "dimensions", sub_sensor_descriptor->dimensions);

    json_object_dotset_value(
        JSON_SubSensorDescriptor, "dimensionsLabel", json_value_init_array());
    ...
    COM_SubSensorStatus_t* sub_sensor_status, JSON_Value* tempJSON)
{
    ...
    json_object_dotset_number(
        JSON_SubSensorStatus, "ODRMeasured", sub_sensor_status->measuredODR);
    json_object_dotset_number(
        JSON_SubSensorStatus, "initialOffset", PRECISION6(sub_sensor_status->initialOffset));
    json_object_dotset_number(JSON_SubSensorStatus, "FS", sub_sensor_status->FS);
    json_object_dotset_number(
        JSON_SubSensorStatus, "sensitivity", PRECISION6(sub_sensor_status->sensitivity));
    json_object_dotset_boolean(JSON_SubSensorStatus, "isActive", sub_sensor_status->isActive);
    json_object_dotset_number(
        JSON_SubSensorStatus, "samplesPerTs", sub_sensor_status->samplesPerTimestamp);
    json_object_dotset_number(
        JSON_SubSensorStatus, "usbDataPacketSize", sub_sensor_status->usbDataPacketSize);
    json_object_dotset_number(
        JSON_SubSensorStatus, "sdWriteBufferSize", sub_sensor_status->sdWriteBufferSize);
    json_object_dotset_number(
        JSON_SubSensorStatus, "wifiDataPacketSize", sub_sensor_status->wifiDataPacketSize);
    json_object_dotset_number(
        JSON_SubSensorStatus, "comChannelNumber", sub_sensor_status->comChannelNumber);
    json_object_dotset_boolean(
        JSON_SubSensorStatus, "ucfLoaded", sub_sensor_status->ucfLoaded);
}
    ...
    COM_AcquisitionDescriptor_t* acquisition_descriptor, JSON_Value* tempJSON)
{
    ...
    json_object_dotset_string(
        JSON_AcquisitionDescriptor, "Name", acquisition_descriptor->name);
    json_object_dotset_string(
        JSON_AcquisitionDescriptor, "Description", acquisition_descriptor->description);
    json_object_dotset_string(
        JSON_AcquisitionDescriptor,
        "UUIDAcquisition",
        acquisition_descriptor->UUIDAcquisition);
    json_object_dotset_string(
        JSON_AcquisitionDescriptor, "start_time", acquisition_descriptor->start_time);
    json_object_dotset_string(
        JSON_AcquisitionDescriptor, "end_time", acquisition_descriptor->end_time);
    ...
    while (HSD_TAGS_get_tag(&type, &class_id, &enable, &time_stamp) == 0)
    {
        ...
        json_object_dotset_string(
            tmp_obj, "Label", HSD_TAGS_get_tag_label(COM_GetDevice(), type, class_id));
