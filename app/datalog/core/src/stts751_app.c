...
static sensor_handle_t stts751_hdl_instance = {
    0, STTS751_0xxxx_ADD_7K5, NULL, 0, &STTS751_ReadSem_id};
static stmdev_ctx_t stts751_ctx_instance = {
    SM_I2C_Write_Os, SM_I2C_Read_Os, &stts751_hdl_instance};
...
void STTS751_OS_Init(void)
{
    ...
    /* Thread 1 definition */
    osThreadDef(
        STTS751_RD_USR_THREAD,
        STTS751_Thread,
        HSD_STTS751_THREAD_PRIO,
        1,
...
__weak void STTS751_Data_Ready(
