...
static sensor_handle_t iis2mdc_hdl_instance = {
    0, IIS2MDC_I2C_ADD, NULL, 0, &iis2mdc_data_read_cmplt_sem_id};
static stmdev_ctx_t iis2mdc_ctx_instance = {
    SM_I2C_Write_Os, SM_I2C_Read_Os, &iis2mdc_hdl_instance};
...
void IIS2MDC_OS_Init(void)
{
    ...
    iis2mdc_data_read_cmplt_sem_id =
        osSemaphoreCreate(osSemaphore(iis2mdc_data_read_cmplt_sem), 1);
    ...
    osThreadDef(
        IIS2MDC_Acquisition_Thread,
        IIS2MDC_Thread,
        HSD_IIS2MDC_THREAD_PRIO,
        1,
...
__weak void IIS2MDC_Data_Ready(
